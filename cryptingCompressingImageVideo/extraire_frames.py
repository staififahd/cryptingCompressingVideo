...
def extraire_frames():
    ...
    fichier_video = "C:/Users/pc/Desktop/Test_Video/video.mp4"
    dossier_destination = "C:/Users/pc/Desktop/Test_Video/Extraire_frames"
    ...
    try:
        ...
        while True:
            ...
            cv2.imwrite(f"{dossier_destination}/frame{compteur_frames}.jpg", frame)
