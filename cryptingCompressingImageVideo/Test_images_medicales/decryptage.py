...
def decrypt_images_in_folder(key):
    ...
    input_folder = "C:/Users/pc/Desktop/Test_images_médicales/Cryptages_frames"
    output_folder = "C:/Users/pc/Desktop/Test_images_médicales/Deryptages_frames"

# Clé et vecteur d'initialisation (doivent être les mêmes que ceux utilisés pour le cryptage)
...
def déchiffrement():
    # Obtenir la clé de déchiffrement depuis un fichier
